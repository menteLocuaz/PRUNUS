...
func (s *PeriodoStore) CreatePeriodo(ctx context.Context, p *models.Periodo) (*models.Periodo, error) {
	// Usamos una transacción para mayor seguridad, aunque el UNIQUE INDEX ya protege la concurrencia.
	...
	if err != nil {
		// Manejo específico de error de duplicidad (Unique Constraint)
		// En PostgreSQL el código 23505 es unique_violation
...
func (s *PeriodoStore) DeletePeriodo(ctx context.Context, id uuid.UUID) error {
	return nil
}
