-- 1. FUNCIÓN DE REGISTRO DE FACTURACIÓN ATÓMICA
-- Procesa Cabecera, Detalles y Pagos en una sola transacción.
...
DECLARE
    ...
    v_error_msg         TEXT;
BEGIN
    -- ── 1. Resolver estados base ─────────────────────────────────────
    -- Obtenemos el estado 'Activo' para la factura y sus registros relacionados.
